...
from model.RanwanNet2 import LoRA_Sam
...
def main():
    ...
    if args.dataset == 'deepglobe':
        if args.backbone == 'resnet50':
            if args.shot == 1:
                checkpoint_path = './outdir/RanwanNet/deepglobe/fine_tuning/resnet50_1shot_avg_50.50.pth'
            if args.shot == 5:
                checkpoint_path = './outdir/RanwanNet/deepglobe/fine_tuning/resnet50_5shot_avg_58.61.pth'
    if args.dataset == 'isic':
        if args.backbone == 'resnet50':
            if args.shot == 1:
                checkpoint_path = './outdir/RanwanNet/isic/fine_tuning/resnet50_1shot_avg_74.38.pth'
            if args.shot == 5:
                checkpoint_path = './outdir/RanwanNet/isic/fine_tuning/resnet50_5shot_avg_77.93.pth'
    if args.dataset == 'lung':
        if args.backbone == 'resnet50':
            if args.shot == 1:
                checkpoint_path = './outdir/RanwanNet/lung/fine_tuning/resnet50_1shot_avg_76.91.pth'
            if args.shot == 5:
                checkpoint_path = './outdir/RanwanNet/lung/fine_tuning/resnet50_5shot_avg_78.19.pth'
    if args.dataset == 'fss':
        if args.backbone == 'resnet50':
            if args.shot == 1:
                checkpoint_path = './outdir/RanwanNet/fss/fine_tuning/resnet50_1shot_avg_83.22.pth'
            if args.shot == 5:
                checkpoint_path = './outdir/RanwanNet/fss/fine_tuning/resnet50_5shot_avg_84.89.pth'
